  ...
  return (
    <main className="min-h-screen bg-white text-black p-4 space-y-6 pb-40">
      <h1 className="text-xl font-bold">
        Swipe Test <span className="text-red-600">v5</span> (pansamantala)
      </h1>
      <p className="text-xs font-bold text-red-600">
        Kung walang &quot;v5&quot; sa taas, LUMA pa ang page — i-reload muna!
        v5 = makinis na finger-follow (rAF) sa mga totoong carousel ng homepage.
      </p>
